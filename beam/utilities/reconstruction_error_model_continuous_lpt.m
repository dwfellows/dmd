function [temporal_recon, alphas] = reconstruction_err_model_continuous(err_modes, err_eigs, state_init, lpt_pred, dt, err_history, state_mean, t_vec, nondim_factor, subset)
  ...
  for k = 1:max_t
    ...
    temporal_recon_k = temporal_recon_k.*nondim_factor + lpt_pred(:,Nt+1);
