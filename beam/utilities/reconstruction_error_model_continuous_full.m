function [temporal_recon] = reconstruction_err_model_continuous_full(err_modes, err_eigs, lpt_pred, dt, err_history, state_mean, t_vec, subset)
  ...
  for k = 1:max_t
    ...
    temporal_recon_k = temporal_recon_k + lpt_pred(:,Nt+1);
